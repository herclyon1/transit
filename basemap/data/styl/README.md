...
- 铁路：Railway-Japan.Light 填充 (113,167,255) 宽 1.3、套边同色 0.49 带 4/48 刻度；苹果像素里同色横向连续 1–2 px、我们 2–3 px。多出来的主要是 OSM 铁路每条股道各一条线（OpenMapTiles 全部保留），苹果一条线路一条中心线；另有 MapLibre 抗锯齿多出约 1 px。暗色铁路 (35,48,69) 在 (55,72,93) 陆地上就是苹果的数。
