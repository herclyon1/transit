...
(function(){
  ...
  rule({name:'卡片/面板/弹出窗的关闭 = 工具条玻璃钮 Medium 24（红绿灯属于浏览器窗口，网页里不画）', ref:'macOS 27 Kit › Titlebars and Toolbars › Buttons › Medium 24', plat:'mac', sel:'.sheet .head .btn-glass', check:el=>{ const r=rect(el); return near(r.width,24)&&near(r.height,24)?[]:[`${num(r.width)}×${num(r.height)}≠24`]; }});
