...
CITY_HINT={'urumqi':{'in':['乌鲁木齐','乌市','天山区','沙依巴克区','沙区','新市区','水磨沟区','水区','头屯河区','头区','米东区','高新区','经开区','开发区','机场','地铁'],
                     'suburb':['达坂城','乌鲁木齐县'],'out':['昌吉','石河子','库尔勒','哈密','吐鲁番','克拉玛依','伊犁','喀什','阿克苏','五家渠','阜康','呼图壁','奇台','和田','博乐','塔城','阿勒泰','乌苏','奎屯','库车','沙湾']}}
