...
let names = ["magnifyingglass","xmark","chevron.right","chevron.left","chevron.up","chevron.down","location.fill","location",
             ...
             "chart.bar","circle.fill","circle","gauge.with.dots.needle.67percent","arrow.left","arrow.right","eye","eye.slash","phone.fill","arrow.up.right","qrcode","pin","pin.fill","pin.slash","chevron.up.chevron.down","line.3.horizontal.decrease.circle"]
for n in names {
